...
export const parseUsAddress = function (address, options) {
    if (!address) {
    ...
    let resultAddressLine2 = temporaryLine2;
...
export const makeFormattedAddress = (stateCode, placeName, line1, zipCode) => {
    return (line1 ? (line1 + ", ") : '') + placeName + ", " + stateCode + (zipCode ? (" " + zipCode) : '');
};
export const makeAddressId = (formattedAddress) => {
