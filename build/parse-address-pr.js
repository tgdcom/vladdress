...
export const parsePrAddress = function (address, options) {
    if (!address) {
    ...
    if (addressParts.length === 2) {
        ...
        if (line1Idx !== -1) {
            ...
            let resultAddressLine2 = streetLine;
            ...
            const resultFormattedAddress = makeFormattedAddress(resultStateAbbreviation, resultPlaceName, addressString, resultZipCode);
            return {
                zipCode: resultZipCode,
                zipCodePlusFour: resultZip4,
                stateAbbreviation: resultStateAbbreviation,
